...
Particles.prototype = {
  ...
  initElements: function () {
    ...
    this.linesGeometry.addAttribute(
      'position',
      new THREE.BufferAttribute(this.linePositions, 3).setDynamic(true)
    )
    this.linesGeometry.addAttribute(
      'color',
      new THREE.BufferAttribute(this.lineColors, 3).setDynamic(true)
    )
